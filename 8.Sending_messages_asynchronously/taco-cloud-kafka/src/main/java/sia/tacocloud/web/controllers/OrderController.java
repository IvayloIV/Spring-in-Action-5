...
import sia.tacocloud.service.KafkaOrderMessagingService;
...
public class OrderController {
    ...
    @GetMapping("/message")
    public ResponseEntity<Order> message() {
        Order order = this.orderRepository.findById(1L).get();
        this.kafkaOrderMessagingService.sendOrderWithTimestamp(order);
